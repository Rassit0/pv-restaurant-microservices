...
async function bootstrap() {
  ...
  const logger = new Logger('Supplier MS');
  ...
  useContainer(app.select(AppModule), {fallbackOnErrors: true}); // Para q funcione las validaciones personalizadas
  ...
  logger.log('Suppliers Microservice ronning');
}
bootstrap();
