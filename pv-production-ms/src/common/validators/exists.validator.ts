...
const modelMap = {
  recipe: (prisma: PrismaService) => prisma.recipe,
  parallelGroup: (prisma: PrismaService) => prisma.parallelGroup,
...
export class ExistsConstraint implements ValidatorConstraintInterface {
  ...
  async validate(value: any, args: ValidationArguments) {
    ...
    // console.log("🔍 Prisma models disponibles:", Object.keys(this.prisma));
