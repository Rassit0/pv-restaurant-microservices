...
async function bootstrap() {
  ...
  const logger = new Logger("Warehueses MS");
  ...
  useContainer(app.select(AppModule), { fallbackOnErrors: true }); // Para que funciones las validaciones personalizadas
  ...
  logger.log('Warehouses Microservices running');
}
bootstrap();
